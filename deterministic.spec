...
hiddenimports += [
    ...
    'electrum.websockets',
    'electrum.gui.qt',
    'electrum.gui.qt.qrreader.qtmultimedia.camera_dialog',
    'PyQt5.sip',
    ...
    'electrum.plugins.cosigner_pool.qt',
    'electrum.plugins.digitalbitbox.qt',
    'electrum.plugins.email_requests.qt',
    'electrum.plugins.keepkey.qt',
    'electrum.plugins.revealer.qt',
    'electrum.plugins.labels.qt',
    'electrum.plugins.scan_over_gap.qt',
    'electrum.plugins.trezor.qt',
    'electrum.plugins.safe_t.client',
    'electrum.plugins.safe_t.qt',
    'electrum.plugins.ledger.qt',
    'electrum.plugins.virtualkeyboard.qt',
]

datas = [
    ('electrum/checkpoints*.*', 'electrum'),
    ('electrum/*.json', 'electrum'),
#    ('electrum/locale', 'electrum/locale'),
    ('electrum/wordlist', 'electrum/wordlist'),
...
exe = EXE(pyz,
          ...
          upx=False,
          console=False,
          icon='electrum/gui/icons/electrum-kiiro.ico',
...
exe_portable = EXE(
    ...
    a.binaries,
    a.datas,
    name=os.path.join('build\\pyi.win32\\electrum-kiiro', 'portable-%s' % cmdline_name),
    debug=False,
    strip=None,
    upx=False,
    icon='electrum/gui/icons/electrum-kiiro.ico',
