...
from electrum.util import make_aiohttp_session, versiontuple
from electrum.logging import Logger
from electrum.network import Network


class UpdateCheck(QDialog, Logger):
    url = "https://raw.githubusercontent.com/kiirocoin/electrum-kiiro/master/.latest-version"
    download_url = "https://github.com/kiirocoin/electrum-kiiro/releases"
    ...
    def __init__(self, *, latest_version=None):
        ...
        self.setWindowTitle('Kiiro Electrum - ' + _('Update Check'))
    ...
    def update_view(self, latest_version=None):
        if latest_version:
            ...
            if self.is_newer(latest_version):
                ...
                self.detail_label.setText(_("You are already on the latest version of Kiiro Electrum."))
        else:
            self.heading_label.setText('<h2>' + _("Checking for updates...") + '</h2>')
            self.detail_label.setText(_("Please wait while Kiiro Electrum checks for available updates."))
