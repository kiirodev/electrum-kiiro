...
#:import SpinBox electrum.gui.kivy.uix.spinbox.SpinBox
...
<EXWarnPopup@Popup>
    ...
    BoxLayout:
        ...
        orientation: 'vertical'
        Image:
            source:'atlas://electrum/gui/kivy/theming/atlas/light/error'
            size_hint_y: 0.1
        Label:
            size_hint_y: 0.4
            id: warn_msg
...
<PSMixingTab@BoxLayout>
    ...
    ScrollView:
        GridLayout:
            ...
            CardSeparator
            SettingsItem:
                title: root.keep_amount_text + ': %s Kiiro' % root.keep_amount
