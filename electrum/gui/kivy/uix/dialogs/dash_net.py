        ...
        ScrollView:
            GridLayout:
                ...
                SettingsItem:
                    ...
                    description: _('Number of currently connected Kiiro peers')
                    action: root.show_peers
                CardSeparator
                SettingsItem:
                    title: _('Max Peers') + ': %s' % root.max_peers
                    description: _('Maximally allowed Kiiro peers count')
                ...
                SettingsItem:
                    ...
                    description: _('Kiiro Sporks Values')
                    action: root.show_sporks
                CardSeparator
                SettingsItem:
                    title: _('Banlist') + ': %s' % len(root.banlist)
                    description: _('Banned Kiiro Peers')
